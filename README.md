...
- **动态选项引导**：每个问题提供 3-4 个预设选项，加速决策过程
...
- 结构化状态定义
- 转换规则
- 独立对话脚本（每个问题配有 Interactive Options 节）

### 交互式选项设计
工作流中的每个交互问题都包含 `Interactive Options` 节，提供：
- 3-4 个预设选项框架
- 基于用户上下文的动态生成指导
- 覆盖全面、差异明显、有启发性的选项
- 保留自定义输入空间

这种设计让用户可以快速选择或自由输入，降低决策负担，提升工作流效率。
